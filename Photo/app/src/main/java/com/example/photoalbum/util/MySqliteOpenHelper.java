...
public class MySqliteOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_NAME_PHOTO = "photo";//定义数据里表的常量名字

    private static final String CREATE_TABLE_SQL = "create table " + TABLE_NAME_PHOTO + "(id integer primary key autoincrement,name)";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        userSql = "create table user(id integer primary key autoincrement,account,name,password,photo,sex)";
        //db.execSQL(newsSql);
