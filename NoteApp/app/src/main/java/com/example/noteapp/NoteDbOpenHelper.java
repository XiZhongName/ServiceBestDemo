...
public class NoteDbOpenHelper extends SQLiteOpenHelper {
    private static final String DN_NAME = "noteSQLite.db";//定义数据库的名字
    private static final String TABLE_NAME_NOTE = "note";//定义数据库里表的名字
    ...
    public long insertData(Note note){
        ...
        ContentValues values = new ContentValues();//存储基本数据类型
    ...
    public int deleteFromDbById(String id){
        ...
        //db.delete(TABLE_NAME_NOTE,"id like ?", new String[]{id});
        //db.delete(TABLE_NAME_NOTE,"id is ?", new String[]{id});
    ...
    public List<Note> queryFromDbAll(){
        SQLiteDatabase db = getWritableDatabase();
